...
While simple and easy to implement (see, for example, what we did in [Guide 11](guide11_combine.qmd), this approach ignores that large degree of variation in lived experience. To capture some of this variation, some studies have used data-driven, e.g.:
...
To find out more about the data, we strongly recommend you consult the data resource profiles, especially those dedicated to each dataset:
