...
* Although NPD generally has low levels of missing data on key variables, data can still be missing. You may be able to infer values from other sources. Ensure you check the metadata to spot how values such as “unclear,” “not provided” or “unknown” are coded as these will not always be imported as system missing values.
