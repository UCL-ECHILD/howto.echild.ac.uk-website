# Enrolment, exclusions and absence {#sec-enr-abs-excl}
...
At the end of these three scripts, we have created three datasets that contain children’s secondary school enrolment data, their exclusions and yearly absence. As with the other intermediate datasets, we will return to these when we join back onto the cohort spine in @sec-combine.

# Coming up...

@sec-exam will turn to exam results, focusing particularly on GCSE results at the end of secondary school.
