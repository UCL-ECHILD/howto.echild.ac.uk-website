...
| @sec-mgmt | [00a_run_cleaning.r](scripts/00a_run_cleaning.r), [00b_prelim.r](scripts/00b_prelim.r) |
| @sec-data-table | Coming soon |
| @sec-cohort | [01a_identify_npd_cohort.r](scripts/01a_identify_npd_cohort.r), [01b_identify_hes_cohort.r](scripts/01b_identify_hes_cohort.r) |
| @sec-demo-npd | [02_npd_demographic_modals.r](scripts/02_npd_demographic_modals.r), [03_npd_demographic_year7.r](scripts/03_npd_demographic_year7.r), [04_npd_demographic_ever.r](scripts/04_npd_demographic_ever.r) |
| @sec-demo-hes | None |
| @sec-birth_chars | [05_hes_birth_characteristics.r](scripts/05_hes_birth_characteristics.r) |
| @sec-phenotype | [06_chc_diagnoses.r](scripts/06_chc_diagnoses.r) |
| @sec-enr-abs-excl | [07_enrolment.r](scripts/07_enrolment.r), [08_exclusion.r](scripts/08_exclusion.r), [09_absence.r](scripts/09_absence.r) |
| @sec-exam | [10_exams.r](scripts/10_exams.r) |
| @cec-opa | [11_outpatient_data.r](scripts/11_outpatient_data.r) |
| @sec-combine | [12_combine.r](scripts/12_combine.r) |
| @sec-csc | None |

: Table 1. Series of guides and scripts

You will notice that we do not have a script for extracting and cleaning children’s social care (CSC) data. This is because we have already [produced and published CSC data extraction and cleaning code that produces cleaned datasets](https://www.adruk.org/our-mission/our-impact/echild-childrens-social-care-and-the-impact-of-code-sharing/){target="_blank"}. We will use this cleaned dataset to very easily extract some flags into our cohort. This is dealt with via code in [Guide 12](combine.qmd) whereas [Guide 13](csc.qmd) discusses the CSC data more generally.
...
@sec-mgmt will take you through some preliminary matters for working with ECHILD on the SRS, including where to the find the data, how to run SQL queries, the importance of modular coding and how we have set up the working directory and other matters that will be used throughout all the guides.
