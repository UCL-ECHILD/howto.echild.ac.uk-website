...
Not all projects need access to all data and so you may not be able to reproduce all scripts exactly as they are given in these guides. Additionally, there are datasets we have not used, such as exams results from other Key Stages or the early years data. There should, however, be enough to get you going. You are free to adapt the scripts as you wish for your work.

# The scripts

To answer our research question, we will create an analysis-ready dataset in a series of steps as outlined across several guides, each with its own R scripts (Table 1).
...
| 3 | [Identify a cohort and create a cohort spine](guide03_cohort.qmd) | [01a_identify_npd_cohort.r](scripts/01a_identify_npd_cohort.r) |
...
# How much R do I need?

These guides assume at least a basic working knowledge of R. Throughout we try to explain the more unusual and trickier concepts in detail. 

# What version of R do I need?

Because we have used only two packages, both of which are very widely used, we hope that the code provided here will prove robust to updates to R. The code was all developed and tested inside the Secure Research Service using R 4.4.0.
