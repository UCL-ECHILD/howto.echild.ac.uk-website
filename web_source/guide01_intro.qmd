...
We will create an analysis-ready dataset across several guides, each with its own R scripts. You can download the scripts using the links in Table 1, below, or at the start of each guide. While these guides are not exhaustive of everything you can or should do with ECHILD, we hope that they will serve as a useful starting point and reference to support you in your data management and analyses.
